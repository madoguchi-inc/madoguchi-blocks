...
function madoguchi_blocks_phone_cta_icon( $key ) {
	$paths = array(
		...
		// 指でタップ（WEB 査定ボタン用）。src/condition-card/icons.js の PATHS.touch と同じ図形。変更時は両方を同期する。
